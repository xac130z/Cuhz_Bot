...
import { e as ensureTwitchBotUserColumns, g as generateBotToken } from "./twitch-bot-Bc9aEPa2.js";
...
async function PATCH(request) {
  try {
    ...
    let nextEnabled = typeof enabled === "boolean" ? enabled : Boolean(user.bot_enabled);
